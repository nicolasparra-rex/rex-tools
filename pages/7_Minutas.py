...
with tab_rem:
    ...
    vendedor_r      = c1.selectbox("Vendedor", ['Alicia Jensen', 'Camila Huber', 'Cristian Astaburuaga', 'Edgardo Verdejo', 'Francisca Soto', 'Francisco Reig', 'Gislaine Sepulveda', 'Gonzalo Pereira', 'Jenny Chavarro', 'Juan Carlos Rabi', 'Marcelo Baeza', 'Matías Ossandon', 'Mauricio Bastías', 'Roberto Ramírez', 'Sebastian Ulloa', 'Tamara Castro', 'Valentina Berrios', 'Yanin Rebolledo'], key="r_vendedor")
...
with tab_asi:
    ...
    vendedor_a      = c5.selectbox("Vendedor", ['Alicia Jensen', 'Camila Huber', 'Cristian Astaburuaga', 'Edgardo Verdejo', 'Francisca Soto', 'Francisco Reig', 'Gislaine Sepulveda', 'Gonzalo Pereira', 'Jenny Chavarro', 'Juan Carlos Rabi', 'Marcelo Baeza', 'Matías Ossandon', 'Mauricio Bastías', 'Roberto Ramírez', 'Sebastian Ulloa', 'Tamara Castro', 'Valentina Berrios', 'Yanin Rebolledo'], key="a_vendedor")
